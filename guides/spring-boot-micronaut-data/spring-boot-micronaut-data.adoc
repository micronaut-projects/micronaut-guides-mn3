...
NOTE: Learn how to leverage Java records for immutable configuration, Micronaut Data Mapped Entities and Projection DTOs in the https://micronaut-projects.github.io/micronaut-guides-mn3/latest/micronaut-java-records.html[Micronaut Data and Java Records] guide.
